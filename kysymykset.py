...
sql7 = f"SELECT name FROM airport ORDER BY RAND() LIMIT 1"
sql8 = f"SELECT gps_code FROM airport WHERE name = '{kysymys[3]}'"
sql9 = f"SELECT gps_code FROM airport WHERE NOT name = '{oikea_vastaus[3]' ORDER BY RAND() LIMIT 3"
